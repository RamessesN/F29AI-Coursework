...
\begin{itemize}
    ...
    \item $C$: The set of $9 \times 3$ all-different constraints:
    \begin{itemize}
...
\begin{enumerate}
    ...
    As stated in Part~\ref{subsection:Procedure}, model the puzzle as a CSP:
    \[
...
\begin{itemize}
    ...
    Specifically, puzzles and its corresponding solutions from each level are provided by \href{https://www.sudoku.name/index.php?ln=cn&puzzle_num=&play=1&difficult=4&timer=&time_limit=0&killer_sudoku=0}{\textit{Sudoku Name}}.
