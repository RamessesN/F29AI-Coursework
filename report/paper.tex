...
%----------------------------------------------------------------------------------------
The predicates are categorized by their functionality as shown in the following table:
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{}l l X@{}}
        ...
        \midrule
        \multirow{3}{*}{\shortstack[l]{Position \&\\Movement}} 
        ...
        \midrule
        \multirow{3}{*}{\shortstack[l]{Assignment \&\\Deployment}} 
        ...
        \multirow{5}{*}{Data-related} 
            ...
            & \texttt{(holding-data ?r ?d)} & Rover currently holds data. \\
            & \texttt{(transmitted ?d ?l)} & Data sent back to lander. \\
        \midrule
        \multirow{4}{*}{Sample-related} 
            & \texttt{(sample-at ?s ?l)} & Sample availability at location. \\
            & \texttt{(holding-sample ?r ?s)} & Rover is carrying a sample. \\
            & \texttt{(sample-picked-up ?s)} & Global flag: sample has been collected. \\
            & \texttt{(sample-stored ?s)} & Global flag: sample is safely stored. \\
...
\textbf{\textit{Note}}: For the complete video recording, please refer to \href{https://heriotwatt-my.sharepoint.com/:v:/g/personal/yz2135_hw_ac_uk/IQC1OfCjBD4BS43vFo2gdDVOAeDYJkMZha4YHIN50qMwmmw}{Microsoft Team} \cite{video_microsoft_team}.
...
\begin{thebibliography}{99}
    ...
    F29AI - Artificial Intelligence and Intelligent Agents. ``Heriot-Watt Report Criteria.'' [Online].
    Available: \url{https://github.com/ZhangKeqin0307/couresework1/blob/main/doc/F29AI_CW1_2025_en.pdf}

    \bibitem{video_microsoft_team}
    Mircrosoft Team. ``Video on the drive.'' [Online].
    Availeable: \url{https://heriotwatt-my.sharepoint.com/:v:/g/personal/yz2135_hw_ac_uk/IQC1OfCjBD4BS43vFo2gdDVOAeDYJkMZha4YHIN50qMwmmw}
